...
const C = {
  ...
  grey: { name: 'رصاصي', nameEn: 'Grey', hex: '#8A8A90' },
  charcoal: { name: 'فحمي', nameEn: 'Charcoal', hex: '#3A3B3F' },
  navy: { name: 'نيلي', nameEn: 'Navy', hex: '#1E2A44' },
  blue: { name: 'أزرق', nameEn: 'Blue', hex: '#2563EB' },
  sky: { name: 'سمائي', nameEn: 'Sky Blue', hex: '#9BBECB' },
  red: { name: 'أحمر', nameEn: 'Red', hex: '#DC2626' },
  burgundy: { name: 'أحمر برغندي', nameEn: 'Burgundy', hex: '#6B0F1A' },
  brown: { name: 'بني', nameEn: 'Brown', hex: '#6A4A32' },
  darkBrown: { name: 'قهوائي', nameEn: 'Dark Brown', hex: '#3E2723' },
  tan: { name: 'حني', nameEn: 'Tan', hex: '#B08A5F' },
  camel: { name: 'حني', nameEn: 'Camel', hex: '#C4A075' },
  beige: { name: 'بيجي', nameEn: 'Beige', hex: '#D9C3B0' },
  nude: { name: 'بيجي', nameEn: 'Beige', hex: '#D9C3B0' },
  gold: { name: 'أصفر', nameEn: 'Yellow', hex: '#EAB308' },
  silver: { name: 'فضي', nameEn: 'Silver', hex: '#C6C7CB' },
  olive: { name: 'زيتوني', nameEn: 'Olive', hex: '#5B6045' },
  green: { name: 'أخضر', nameEn: 'Green', hex: '#16A34A' },
  rose: { name: 'وردي باهت', nameEn: 'Dusty Rose', hex: '#C9A0A0' },
  pink: { name: 'وردي', nameEn: 'Pink', hex: '#E8A5B8' },
