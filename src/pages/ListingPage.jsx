...
import { Close, Search, Sliders } from '../components/Icons';
...
export default function ListingPage() {
  ...
  // The unfiltered pool for this route — everything else derives from it.
  ...
  // Route change means a new pool, so the price ceiling has to be re-seeded.
  useEffect(() => {
    setFilters({ maxPrice: bounds.max, colors: [], sizes: [], onSale: false, isNew: false });
    setSort('featured');
  }, [bounds.max, gender, category, sub]);
